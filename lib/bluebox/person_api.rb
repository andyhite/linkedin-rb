module Bluebox
  module PersonAPI
    ...
    MEMBERSHIP_FIELDS = ['person', 'group', 'membership-state', 'show-group-logo-in-profile', 
      'allow-messages-from-members', 'email-digest-frequency', 'email-announcements-from-managers', 
      'email-for-every-new-post']
      
    SUGGESTION_FIELDS = ['id', 'name', 'short-description', 'description', 'relation-to-viewer', 'posts', 
